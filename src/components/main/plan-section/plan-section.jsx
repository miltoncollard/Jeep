        ...
        <div className="planSection" id="planSection">
            ...
            <div className= "plan-content">            
                <div className="text-plan">
                    ...
                    <p>Es un sistema mediane el cuál, un grupo limitado de personas realiza un aporte mensual, 
                        destinado a la aquisición de una unidad y que será entregada en un período determinado a cada uno de los integrantes. 
                ...
                <div className="advantage">
                    <h2>Ventajas</h2>
                    <ul>
                        <li> Financión del 100% del valor.</li>
